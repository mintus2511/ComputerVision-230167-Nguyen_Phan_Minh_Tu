...
img = cv2.imread('test_img.jpg')  # Change to your image path
...
# Step = 1 degree in default, converted to radian
...
# choose threshold value experimentally
lines_idxs = np.argwhere(accumulator > 100)
