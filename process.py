...
from Week2_Filtering.Week2_Ex2_Guassian import GaussianProcessor
from Week2_Filtering.Week2_Ex3_Median import MedianBlurProcessor
...
class ImageProcessor:
    ...
    def process_frame(self, bgr_img):
        ...
        step1_image = saveImg.capture_and_save_image(
            bgr_img, "test_capture.bmp")  # Step 1: Capture and Save Image
        ######################## IMAGE FILTERING ########################################
        # Step 2: Convert to Grayscale
        grayScaleProcessor = GrayscaleProcessor()
        processed_img = grayScaleProcessor.convert_to_grayscale(bgr_img)
        # Save Processed Image
        step2_image = saveImg.capture_and_save_image(
            processed_img, "processed_capture.bmp")

        # Step 3: Convert to Guassian Blur
        # guassianProcessor = GaussianProcessor()
        # processed_img = guassianProcessor.apply_gaussian_filter(bgr_img)
        # Save Processed Image
        # step3_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")

        # Step 4: Convert to Median Blur
        # medianProcessor = MedianBlurProcessor()
        # processed_img = medianProcessor.convert_to_blur(bgr_img)
        # Save Processed Image
        # step4_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")

        # Step 5: Sobel Filter
        # sobelProcessor = SobelProcessor()
        # processed_img = sobelProcessor.apply_sobel_filter(bgr_img)
        # Save Processed Image
        # step5_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")

        # Step 6: Laplacian Filter
        # laplacian_processor = laplacianProcessor()
        # processed_img = laplacian_processor.apply_laplacian_filter(bgr_img)
        # Save Processed Image
        # step6_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")

        # Step 7: Sharpening Filter
        # sharpening_processor = SharpeningProcessor()
        # processed_img = sharpening_processor.apply_sharpening_filter(bgr_img)
        # Save Processed Image
        # step7_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")

        # Step 8: Bilateral Filter
        # bilateral_processor = BilateralProcessor()
        # processed_img = bilateral_processor.apply_bilateral_filter(bgr_img)
        # Save Processed Image
        # step8_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")

        # Step 9: Thresholding
        # thresholding_processor = ThresholdingProcessor()
        # processed_img = thresholding_processor.apply_thresholding_filter(bgr_img)
        # Save Processed Image
        # step9_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")

        # Step 10: Erosion
        # erosion_processor = ErosionProcessor()
        # processed_img = erosion_processor.apply_erosion_filter(bgr_img)
        # Save Processed Image
        # step10_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")

        # Step 11: Dilation
        # dilation_processor = DilationProcessor()
        # processed_img = dilation_processor.apply_dilation_filter(bgr_img)
        # Save Processed Image
        # step11_image = saveImg.capture_and_save_image(processed_img, "processed_capture.bmp")
        #################################################################################
